                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/Shiranmadusha'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+94715142059'
                                }
                            }, {
                                quickReplyButton: {
...
⭔ Url : ${anu.url}`,
	    ...
	    case 'play1':
                            ...
                            const playy = await axios.get(`https://bx-hunter.herokuapp.com/api/yt/search?query=${body.slice(6)}&apikey=${'apikey'}`)
...
Lihat list Pesan Dengan ${prefix}listmsg`)
	    ...
	    case 'anonymous': {
            ...
            case 'public': {
                if (!isCreator) throw mess.owner
                hisoka.public = true
                m.reply('HUNTER-X BOT ready to Public Usage')
            }
            break
            case 'self': {
                if (!isCreator) throw mess.owner
                hisoka.public = false
                m.reply('HUNTER-X BOT ready to Self Usage')
            }
            break
